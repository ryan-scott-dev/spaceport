Spaceport.DockBuildingPlacement = function(params) {
  Spaceport.BuildingPlacement.call(this, params);
};

Spaceport.DockBuildingPlacement.mixin(Spaceport.BuildingPlacement.prototype);

Spaceport.DockBuildingPlacement.mixin({

  calculatePlacingPositions: function() {

    // Find the dominate axis
    var startPos = this.currentStartPlacementPosition;
    var endPos = this.currentEndPlacementPosition || new Phaser.Point(startPos.x + 96, startPos.y + 128);
